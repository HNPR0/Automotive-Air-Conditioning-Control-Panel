...
title Embedded AC System - Layered Architecture

' ---------------------------------------------------------
' 1. APPLICATION LAYER
' ---------------------------------------------------------
package "Application Layer" <<Application>> {
    file "Temperature Control Logic"
    file "Mode Selection Logic"
}
...
package "HAL Layer" <<HAL>> {
    ...
    rectangle "User Interface Modules" {
        file "Keypad"
        file "Push Buttons"
        file "LED Indicator"
        file "LCD Display"
    ...
    rectangle "Actuator Modules" {
        file "DC Motor (Fan)"
    }

    rectangle "Sensor Modules" {
        file "LM35 Temperature Sensor"
    }
...
' CONNECTIONS
' ---------------------------------------------------------
"Application Layer" -- "User Interface Modules"
"Application Layer" -- "Actuator Modules"
"Application Layer" -- "Sensor Modules"
"MCAL Layer" -up-> "User Interface Modules"
